...
config[:casper] = {
  ...
  author: {
    name: 'Ned P.',
    bio: "Polyglot (Ruby and Crystal guy)", # Optional
    location: nil, # Optional
    website: 'https://nedpals.xyz', # Optional
    gravatar_email: nil, # Optional
    twitter: 'https://twitter.com/npned' # Optional
  },
  navigation: {
    "Home" => "/",
    "GitHub" => "https://github.com/nedpals",
    "Portfolio" => "https://nedpals.xyz"
  }
}
